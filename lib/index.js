...
(function() {
  var LINE_PREFIX, childProcess, compact, compactMap, createFilter, createGlobFilter, createRegExpFilter, flatten, glob, identity, isRegExp, isString, keys, map, watch, wrap, _,
  ...
  module.exports = function(path, command, options) {
    ...
    Reaktr = (function() {
      ...
      Reaktr.prototype.parseFile = function(file) {
        ...
        if (!(typeof included === "function" ? included(file) : void 0)) {
          file = null;
        }
