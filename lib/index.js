...
(function() {
  var LINE_PREFIX, childProcess, compact, compactMap, flatten, isRegExp, isString, keys, map, watch, wrap, _, _ref,
  ...
  module.exports = function(path, command, options) {
    ...
    if ((include != null) && isRegExp(include)) {
    ...
    if ((exclude != null) && isRegExp(exclude)) {
