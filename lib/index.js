...
(function() {
  var LINE_PREFIX, childProcess, compact, compactMap, flatten, isString, keys, map, watch, wrap, _ref,
  ...
  _ref = require('underscore'), wrap = _ref.wrap, map = _ref.map, flatten = _ref.flatten, compact = _ref.compact, isString = _ref.isString, keys = _ref.keys;
    ...
    Reaktr = (function() {
      ...
      Reaktr.prototype.processRestarter = function(startFn) {
        ...
        return function() {
          ...
          _this.process = startFn();
          return _this.process.on('exit', _this.onProcessExit);
        };
      };

      Reaktr.prototype.killProcess = function() {
        this.log("Killing process with PID " + this.process.pid);
        return this.process.kill();
      };

      Reaktr.prototype.onProcessExit = function(code) {
        var _ref1;
        if (code == null) {
          code = 0;
        }
        this.log("PID " + ((_ref1 = this.process) != null ? _ref1.pid : void 0) + " exited with " + code);
        this.log("");
