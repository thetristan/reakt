...
(function() {
  var child, equal, expect, glob, reakt, spy, watch, _, _ref;
  ...
  describe('reakt', function() {
    ...
    describe('#parseFile', function() {
      it('strips the base path', function() {
        this.subject = createSubject();
        return equal(this.subject.parseFile('/foo/bar/baz/test.js'), 'baz/test.js');
      });
      ...
      return context('with a glob pattern', function() {
        beforeEach(function() {
          return this.subject = createSubject({
            include: "/baz/*.js",
            exclude: "/baz/qux/*.js"
        ...
        context('if the file does not match the include pattern', function() {
          return it('returns null', function() {
            ...
            return equal(this.subject.parseFile('/foo/bar/baz/ipsum.js'), null);
          });
        });
        return context('if the file matches the exclude pattern', function() {
          return it('returns null', function() {
            spy(glob, 'sync')["return"](['/baz/qux/lorem.js']);
            return equal(this.subject.parseFile('/foo/bar/baz/qux/lorem.js'), null);
          });
        });
      });
    });
